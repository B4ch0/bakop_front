 ...
 <tr
                        ...
                        >
                            ...
                            <td>
                                ...
                                <td>{{ invoice.client_name }}</td> <!--dodati client ime-->
                            <td>{{ invoice.gross_amount }}</td>
                             <td>{{ invoice.get_due_date_formatted }}</td>     <!--dodaTI DATUM KAD JE NAPAVLJEN RACUN-->
                             <td>{{ getStatusLabel(invoice) }}</td>
                            <td>{{ invoice.get_date_formatted }}</td>   <!--vrijeme -->
